...
export function registerLanguageModelTools(
	...
	context.subscriptions.push(
		...
		lm.registerTool(
			"trust_get_workspace_symbols",
			new STWorkspaceSymbolsTool(),
		),
		lm.registerTool(
		...
		lm.registerTool(
			"trust_hmi_get_bindings",
			new STHmiGetBindingsTool(getClient),
		),
		...
		lm.registerTool(
			"trust_workspace_rename_file",
			new STWorkspaceRenameFileTool(),
		),
		lm.registerTool(
			"trust_update_settings",
			new STSettingsUpdateTool(getClient),
		),
